...
app.get("/createaccount", (req:any, res:any) => {
    res.render("regform.ejs",{loggedin:null,err:null});  
});
app.post("/register", 

upload2.fields([{ name: "nepabill", maxCount: 1 },{name: "IDfile", maxCount: 1},{name: "passportpics", maxCount: 1}]),
_create);
...
app.post("/logggedin",_reguser,(req:any,res:any)=>{
    res.redirect("/")
})
app.get("/logggedin",_authenticate,(req:any,res:any)=>{
    // gfs.remove({ _id: "627fd2766470e8bc0c8ecd9b",root:"uploads" }, (err,data) => {});
    res.send("babaolowo")
})
app.get("/logout",_authenticate,(req:any,res:any)=>{
...
app.get("/dashboard", _authenticate,(req:any, res:any) => {
    res.render("dashboard.ejs",{loggedin:false,transactions:false,err:false}); 
});


app.get("/fund-account",_authenticate, (req:any, res:any) => {
    res.render("populating.ejs" ,{url:"/fund-account_"}) ; 
    
});

app.get("/withdraw",_authenticate,(req:any, res:any) => {
    res.render("populating.ejs" ,{url:"/withdraw_"}) ; 
    
});


app.post("/fund-account_",_authenticate,_withdrawandfund, (req:any, res:any) => {
...
app.post("/withdraw_",_authenticate,_withdrawandfund, (req:any, res:any) => {
